...
hub_score_w_file_path = "/Users/tanushanandam/Desktop/SearchEngineFor_Musicals/musicals-search-engine-server-main/indexer/precomputed/hits_hubs_scores"
authority_score_w_file_path = "/Users/tanushanandam/Desktop/SearchEngineFor_Musicals/musicals-search-engine-server-main/indexer/precomputed/hits_authority_scores"
authority_score_r_file_path = "/Users/tanushanandam/Desktop/SearchEngineFor_Musicals/musicals-search-engine-server-main/indexer/precomputed/hits_hubs_scores"
...
def construct_inlink_map():
    linkdb_inlink_file = open("/Users/tanushanandam/Desktop/SearchEngineFor_Musicals/part-r-00000", 'r').readlines()
...
def compute_hits(urls):
    authority_score_file = open(authority_score_w_file_path, 'r').read()
...
#constructed a directed graph(networkx) where nodes = pages and edges = links